...
export default function GenresFilter({
  ...
  return (
    <div
      className={` absolute top-[120%] -left-1/2  w-[200px]  flex-col bg-black border-[0.15px] border-gray-700 z-10 p-3 gap-2 rounded shadow-lg ${
    ...
    >
      <div className="relative flex flex-col justify-between  border-[0.25] border-gray-400 rounded">
        <div className="flex justify-between relative w-full p-1">
          ...
          <ChevronDownIcon
            className={`absolute right-3 top-1/2 z-20  h-[18px] w-[18px] -translate-y-1/2 text-gray-500 ${
              BooksCountDropdown ? "rotate-180" : ""
            }`}
            onClick={() => handleDropdown("bookCount")}
          />
        </div>
        <div
          className={`StatusDropdown  top-[120%] left-0 right-0 peer-focus:flex flex-col bg-black z-10 p-3 gap-2 rounded shadow-lg ${
            BooksCountDropdown ? "flex" : "hidden"
          }`}
        >
      ...
      <div className="relative flex flex-col justify-between  border-[0.25] border-gray-400 rounded">
        <div className="flex justify-between relative w-full">
          ...
          <ChevronDownIcon
            className={`absolute right-3 top-1/2 z-20  h-[18px] w-[18px] -translate-y-1/2 text-gray-500 ${
              CreationDateDropdown ? "rotate-180" : ""
            }`}
            onClick={() => handleDropdown("creationDate")}
          />
        </div>
        <div
          className={`GenreDropdown  top-[120%] left-0 right-0 peer-focus:flex flex-col bg-black py-3 px-1 z-10 gap-2 rounded shadow-lg ${
            CreationDateDropdown ? "flex" : "hidden"
          }`}
        >
            ...
            <div className="flex justify-between w-full">
              ...
              <div className="relative w-[120px]">
                <input
                  ...
                  className={`w-[120px] h-full text-[12px] border-[0.25px] rounded pl-1 ${
            ...
            <div className="flex text-center justify-between w-full">
              ...
              <div className="relative w-[120px] mr-0 ">
                <input
                  ...
                  value={date}
                  onChange={handleChange}
                  className={`w-full h-full text-[12px] border-[0.25px] rounded pl-1 ${
                    error ? "border-white" : "border-red-500"
                  } `}
                />
                <CalendarDateRangeIcon className="absolute right-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500" />
