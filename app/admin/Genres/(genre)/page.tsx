...
export default function Page() {
    ...
    const form = useForm<z.infer<typeof genreSchema>>({
      ...
      const mutation = useMutation({
        ...
        onSuccess: (data) => {
          console.log('✅ Genre uploaded successfully:', data);
            ...
            >
                <div className="flex gap-10 mt-10 ">
                    ...
                    <div className="flex flex-col gap-5">
                        <input {...form.register("genreName")}  type="text" placeholder='Genre Name' className="w-[400px] p-2 border-[0.25px] border-gray-400 rounded" />
                        <textarea {...form.register("description")}  placeholder='GenreDescription' className="w-[400px] h-[150px]  p-2 border-[0.25px] border-gray-400 rounded" />
                        <button type="submit" className="fancyBorder w-[100px] ml-auto">Save</button>
                    </div>
                </div>
