        ...
        <div className="flex justify-between relative w-full">
          ...
          <ChevronDownIcon
            className={`absolute right-3 top-1/2 z-20  h-[18px] w-[18px] -translate-y-1/2 text-gray-500 ${
              GenreDropdown ? "rotate-180" : ""
            }`}
            onClick={() => handleDropdown("genre")}
          />
        </div>
        <div
          className={`GenreDropdown  top-[120%] left-0 right-0 peer-focus:flex flex-col bg-black z-10 p-3 gap-2 rounded shadow-lg ${
            GenreDropdown ? "flex" : "hidden"
          }`}
        >
