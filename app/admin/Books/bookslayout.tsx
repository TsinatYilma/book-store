    ...
    <div className="h-fit relative  text-white flex flex-col ">
            ...
            <div className="relative flex gap-1" onClick={() => handleFilter()}>
              <FunnelIcon
                className={`w-5 h-5 text-gray-400  ${
                  filterVisible ? "rotate-180 text-green-500" : ""
                }`}
              />
      ...
      <div className="flex justify-between px-2 py-5">
        <div className="flex gap-2">
          <Link
            href={"/admin/Books"}
            className="flex items-center px-2 gap-2 border-[0.25px] bg-black border-gray-700 rounded"
          >
            <Image src={"/books.png"} alt="" width={20} height={1} />
            <p className="">All Books</p>
          </Link>
          <Link
            href="/admin/Books/UploadBook"
            className="flex items-center px-2 gap-2 border-[0.25px] bg-black border-gray-700 rounded cursor-pointer"
          >
