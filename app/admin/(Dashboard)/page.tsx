...
import { fetchDashboardCounts } from "@/app/lib/API_Calls/fetching-data"
  ...
  return (
    <div className="">
      ...
      <div className="flex gap-4 mt-8">
        ...
        <div className="bg-black/20 p-4 rounded-lg flex flex-col gap-2 items-center">
          <div className="flex gap-2 items-center">
            <SparklesIcon className='h-[20px] w-[20px] text-gray-200' />
        ...
        <div className="bg-black/20 p-4 rounded-lg flex flex-col gap-2 items-center">
          <div className="flex gap-2 items-center">
            <UserPlusIcon className='h-[20px] w-[20px] text-gray-200' />
        ...
        <div className="flex flex-col  max-w-[650px]">
          <div className="flex">
            <div className="flex flex-wrap justify-center gap-5 my-12 ">
              <div className="w-[183px] h-[176px] rounded-lg bg-gradient-to-tr from-black to-cyan-900 pl-1 flex flex-col justify-start gap-6 sm:gap-14 border-[0.15] border-gray-700">
                <div className="p-2 w-fit bg-transparent">
                  <FaceSmileIcon className='h-[24px] w-[24px] text-cyan-600 ' />
                </div>
                <div className="">
                  <h1 className="font-bold text-lg text-transparent bg-clip-text bg-gradient-to-b from-cyan-200 to-white">17 Reviews</h1>
              ...
              <div className="w-[183px] h-[176px] rounded-lg bg-gradient-to-tr from-black to-cyan-900 pl-1 flex flex-col justify-start gap-6 sm:gap-14 border-[0.15] border-gray-700">
                ...
                <div className="">
                  <h1 className="font-bold text-lg text-transparent bg-clip-text bg-gradient-to-b from-cyan-200 to-white">5 Messages</h1>
