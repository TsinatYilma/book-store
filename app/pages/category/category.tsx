...
export default function Category({category, TopRatedbooks}:{category:string, TopRatedbooks: Book[]}){
    return(
        <div className="w-fit mx-auto mt-5">
                ...
                <div className="flex flex-col lg:flex-row lg:justify-around lg:gap-8 w-full p-4 sm:w-fit">
                    <div className={"flex flex-col w-full lg:w-fit font-gabarito"}>
                        ...
                        <Catagory category={category ?? "category"} TopRatedbooks={TopRatedbooks}/>
                   </div>
...
function Catagory({category, TopRatedbooks}:{category:string, TopRatedbooks: Book[]}){
