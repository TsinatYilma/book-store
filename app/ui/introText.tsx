...
export default function IntroText() {
  ...
  style={{
    ...
    <p className={handlee.className + " text-[10px] sm:text-[12px] text-center "}>Explore books from the Ethiopian Orthodox Tewahedo Church <br /> by <span className="font-bold text-[#238E8E]">theme</span>, <span className="font-bold text-[#238E8E]">topic</span>, or <span className="font-bold text-[#238E8E]">traditional genre</span>.</p>
    </div>
  );
}