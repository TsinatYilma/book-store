    ...
    return(
        <div className="mt-12 flex flex-col p-2 md:p-0 md:flex-row me:w-full  me:justify-center  gap-5 me:gap-32 ">
            ...
            <div className="flex flex-col justify-center md:justify-start items-center md:items-start gap-3 max-w-[460px] me:max-w-[550px]">
                ...
                <h1 className={`font-gabarito text-left w-full text-2xl me:text-3xl text-cyan-500`}>Saint Paul: The Saint&#39;s life</h1>
                <p className="text-left w-full font-bold">By Abel Kassahun</p>
                <p className={`font-gantari text-[12px] me:text-[16px] text-left w-full `}>A book by diakon and preacher Abel kassahun about the Great saint Paul. Its based on the story of the saint and its contribution to the church.</p>
